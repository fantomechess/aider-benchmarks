...
""",
    ...
    system_reminder = """Use the brain tag instructions for your thought process. Should see thinking -> reasoning -> reflection -> output tags for every response before doing search or replace.
